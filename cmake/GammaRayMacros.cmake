...
macro(gammaray_add_plugin _target_name _desktop_file)
  ...
  set_target_properties(${_target_name} PROPERTIES
    PREFIX ""
    LIBRARY_OUTPUT_DIRECTORY ${PROJECT_BINARY_DIR}/${PLUGIN_INSTALL_DIR}/gammaray
  )
  ...
  configure_file("${CMAKE_CURRENT_SOURCE_DIR}/${_desktop_file}" "${PROJECT_BINARY_DIR}/${PLUGIN_INSTALL_DIR}/gammaray/${_desktop_file}")
endmacro()
