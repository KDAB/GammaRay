...
#if QT_VERSION < QT_VERSION_CHECK(5, 0, 0)
            data[QLatin1String(classNameAsByteArray.data(), classNameAsByteArray.size())];
#else
            data[QLatin1String(classNameAsByteArray)];
#endif
        perClassData.className = std::move(classNameAsByteArray);
