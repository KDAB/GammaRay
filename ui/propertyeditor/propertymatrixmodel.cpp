...
QVariant PropertyMatrixModel::headerData(int section, Qt::Orientation orientation, int role) const
{
  ...
  if (orientation == Qt::Horizontal) {
    switch (m_matrix.type()) {
      case QVariant::Matrix:
        switch (section) {
          case 0: return tr("m_1");
          case 1: return tr("m_2");
        }
        break;
      ...
      case QVariant::Matrix4x4:
        switch (section) {
          case 0: return tr("m_1");
          case 1: return tr("m_2");
          case 2: return tr("m_3");
          case 3: return tr("m_4");
        }
        break;
    ...
    switch (m_matrix.type()) {
      case QVariant::Matrix:
        switch (section) {
          case 0: return tr("m1_");
          case 1: return tr("m2_");
          case 2: return tr("d x/y");
        }
        break;
      ...
      case QVariant::Matrix4x4:
        switch (section) {
          case 0: return tr("m1_");
          case 1: return tr("m2_");
          case 2: return tr("m3_");
          case 3: return tr("m4_");
        }
        break;
      ...
      case QVariant::Quaternion:
        switch (section) {
          case 0: return tr("pitch");
          case 1: return tr("yaw");
          case 2: return tr("roll");
        }
        break;
#endif
      default:
