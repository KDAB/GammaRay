...
#ifndef GAMMARAY_SGGEOMETRYEXTENSIONINTERFACE_H
#define GAMMARAY_SGGEOMETRYEXTENSIONINTERFACE_H
...
Q_DECLARE_INTERFACE(GammaRay::SGGeometryExtensionInterface, "com.kdab.GammaRay.SGGeometryExtensionInterface")
